...
import carsImage from '../assets/contact.jpg';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div>
            ...
            <form>
              ...
              <div className="mb-4">
                <label htmlFor="mobileNumber" className="text-gray-800 font-semibold mb-2">Mobile</label>
                <input type="text" id="mobileNumber" name="mobile" className="w-full px-4 py-2 border border-primary hover:border-black rounded-lg focus:outline-none focus:border-black" />
              </div>
              <div className="mb-4">
              ...
              <div className="text-center">
                <button type="submit" className="bg-primary text-black font-semibold px-6 py-3 rounded-lg hover:bg-black hover:text-white focus:outline-none">Submit</button>
              </div>
            </form>
          </div>
        </div>
